...
CREATE OR REPLACE VIEW v_objets_images AS select o.id, o.nom_obj, o.description,o.date_publication, cat.nom_cat, u.pseudo, i.src
from takalo_objet o join takalo_photos_objets i on o.id = i.id_obj and i.id_obj = (select min(id_obj) from takalo_photos_objets where id_obj = o.id)
 join takalo_users u on o.id_proprietaire = u.id
